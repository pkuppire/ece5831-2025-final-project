...
@dataclass
class ImprovedCNN224Config:
    model_root: str = "models"
    experiment_name: str = "improved_cnn_224"
    model_filename: str = "improved_cnn_224.keras"
...
class ImprovedCNN224Experiment:
    """
    Improved CNN trained at 224x224.
    Conv32/64/128/256 + BN + MaxPool -> Flatten -> Dense(256) -> Dropout(0.5) -> Softmax
    """

    def __init__(self, dm: PlantDiseaseDataModule, cfg: ImprovedCNN224Config):
