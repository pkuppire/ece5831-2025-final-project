# src/pretrained_resnet50_finetune.py
...
@dataclass
class ResNet50FTConfig:
    model_root: str = "models"
    experiment_name: str = "resnet_finetuned_224"
    model_filename: str = "resnet_finetuned_224.keras"
...
class ResNet50FineTuneExperiment:
    
    def __init__(self, dm: PlantDiseaseDataModule, cfg: ResNet50FTConfig):
        self.dm = dm
        self.cfg = cfg
    ...
    def build_model(self, trainable_from: Optional[int]) -> keras.Model:
        ...
        if trainable_from is None:
            ...
            for i, layer in enumerate(backbone.layers):
                if self.cfg.keep_batchnorm_frozen and isinstance(layer, layers.BatchNormalization):
