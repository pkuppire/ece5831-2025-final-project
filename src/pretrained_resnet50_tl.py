...
@dataclass
class ResNet50TLConfig:
    model_root: str = "models"
    experiment_name: str = "resnet_pretrained_224"
    model_filename: str = "resnet_pretrained_224.keras"
...
class ResNet50TransferLearningExperiment:

    def __init__(self, dm: PlantDiseaseDataModule, cfg: ResNet50TLConfig):
        self.dm = dm
        self.cfg = cfg
    ...
    def train_or_load(self, train_ds, val_ds) -> None:
        ...
        print(f"[{self.cfg.experiment_name}] Training ResNet50 TL (frozen backbone)...")
