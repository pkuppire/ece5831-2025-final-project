...
class VGG16TLConfig:
    ...
    experiment_name: str = "vgg_pretrained_224"
    model_filename: str = "vgg_pretrained_224.keras"
...
class VGG16TransferLearningExperiment:
  

    def __init__(self, dm: PlantDiseaseDataModule, cfg: VGG16TLConfig):
        self.dm = dm
        self.cfg = cfg
    ...
    def train_or_load(self, train_ds, val_ds) -> None:
        ...
        print(f"[{self.cfg.experiment_name}] Training VGG16 TL (frozen backbone)...")
